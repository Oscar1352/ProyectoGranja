...
public class NegociarPasto extends JFrame {
    //Declaro mis clases
    ...
    public NegociarPasto() {
        ...
        Border bordejpanel = new TitledBorder(new EtchedBorder(), "COMPRAR pasto");
        ...
        comprar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int Total= x*ventana3.pasto.getPrecio();
                if(datosUsuario.getOro()>=Total){
                    ...
                    Ventana3.pasto.setCantidad(ventana3.pasto.getCantidad()+x);
                    CantidadActual.setText("Unidades actuales: "+ventana3.pasto.getCantidad());
        ...
        vender.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int x= Integer.parseInt(introducir.getText());
                int Total= x*ventana3.pasto.getPrecio();
                if(x>ventana3.pasto.getCantidad()){
