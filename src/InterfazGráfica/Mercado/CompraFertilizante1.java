...
public class CompraFertilizante1 extends JFrame{
    //Declaro mis clases
    ...
    public CompraFertilizante1() {
        ...
        JLabel Cantidad =                    new JLabel("Unidades deseadas a un costo de: "+ventana3.basica.getPrecio());
