...
public class NegociarNueces extends JFrame{
    //Declaro mis clases
    ...
    public NegociarNueces() {
        ...
        int a = 50;
        JLabel Nueces =                     new JLabel("COMPRAR EN EL MERCADO");
        JLabel CantidadActual =              new JLabel("Unidades actuales: "+ventana3.nueces.getCantidad()+" c/u");
        ...
        comprar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int Total= x*ventana3.nueces.getPrecio();
        ...
        vender.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int x= Integer.parseInt(introducir.getText());
                int Total= x*ventana3.nueces.getPrecio();
                if(x>ventana3.nueces.getCantidad()){
