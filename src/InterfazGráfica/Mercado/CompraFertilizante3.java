...
public class CompraFertilizante3 extends JFrame{
    //Declaro mis clases
    ...
    public CompraFertilizante3() {
        ...
        JLabel Cantidad =                    new JLabel("Unidades deseadas a un costo de: "+ventana3.alta.getPrecio());
