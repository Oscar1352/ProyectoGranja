...
public class NegociarFrutas extends JFrame{
    //Declaro mis clases
    ...
    public NegociarFrutas() {
        ...
        int a = 50;
        JLabel Frutas =                     new JLabel("COMPRAR EN EL MERCADO");
        JLabel CantidadActual =              new JLabel("Unidades actuales: "+ventana3.frutas.getCantidad()+" c/u");
        ...
        comprar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int Total= x*ventana3.frutas.getPrecio();
        ...
        vender.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int x= Integer.parseInt(introducir.getText());
                int Total= x*ventana3.frutas.getPrecio();
                if(x>ventana3.frutas.getCantidad()){
    ...
    public static void main(String[] args) {
        NegociarFrutas negociarFrutas= new NegociarFrutas();
    }
}
