...
public class NegociarFertilizante3 extends JFrame{
    //Declaro mis clases
    ...
    public NegociarFertilizante3() {
        ...
        Border bordejpanel = new TitledBorder(new EtchedBorder(), "COMPRAR Fertilizante Alto");
        panel.setBorder(bordejpanel);

        // crear las partes del formulario
        int a = 50;
        JLabel Fertilizante3 =                     new JLabel("COMPRAR EN EL MERCADO");
        JLabel CantidadActual =              new JLabel("Unidades actuales: "+ventana3.alta.getCantidad());
        JLabel Cantidad =                    new JLabel("Unidades deseadas a un costo de: "+ventana3.alta.getPrecio()+" c/u");
        ...
        comprar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int Total= x*ventana3.alta.getPrecio();
                if(datosUsuario.getOro()>=Total){
                    ...
                    Ventana3.alta.setCantidad(ventana3.alta.getCantidad()+x);
                    CantidadActual.setText("Unidades actuales: "+ventana3.alta.getCantidad());
        ...
        vender.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int x= Integer.parseInt(introducir.getText());
                int Total= x*ventana3.alta.getPrecio();
                if(x>ventana3.alta.getCantidad()){
