...
public class Ventana2 extends JFrame {
    ...
    public Ventana2() {
        ...
        JLabel Producto1 = new JLabel("Chipilin ");
        JLabel Producto2 = new JLabel("Pasto ");
        JLabel Producto3 = new JLabel("Vegetales ");
        JLabel Alimento2 = new JLabel("Alimento Omnivoros");
        JLabel Producto11 = new JLabel("Aves ");
        JLabel Producto22 = new JLabel("Frutas ");
        JLabel Producto33 = new JLabel("Insectos ");
        JLabel Cantidad = new JLabel("Producto Animal");
        JLabel Cantidad1 = new JLabel("Cuero ");
        JLabel Cantidad2 = new JLabel("Carne ");
        JLabel Cantidad3 = new JLabel("Huevos ");
        JLabel Cantidad4 = new JLabel("Lana ");
